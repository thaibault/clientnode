...
browserAPI((window:Window, location:Location) => {
    ...
    */
    ...
    qunit.test('isolateScope', () => {
        ...
        qunit.deepEqual(tools.isolateScope(scope, []), {
    ...
    qunit.test('arrayAggregatePropertyIfEqual', () => {
        qunit.strictEqual(
            tools.arrayAggregatePropertyIfEqual([{a: 'b'}], 'a'), 'b')
        qunit.strictEqual(tools.arrayAggregatePropertyIfEqual(
            [{a: 'b'}, {a: 'b'}], 'a'
        ), 'b')
        qunit.strictEqual(
            tools.arrayAggregatePropertyIfEqual([{a: 'b'}, {a: 'c'}], 'a'), '')
        qunit.strictEqual(tools.arrayAggregatePropertyIfEqual(
            [{a: 'b'}, {a: 'c'}], 'a', false
        ), false)
    })
    ...
    qunit.test('arrayExtractIfMatches', () => {
        ...
        qunit.deepEqual(
            tools.arrayExtractIfMatches(['a', 'b'], ''), ['a', 'b'])
    ...
    qunit.test('arrayExtractIfPropertyExists', () => {
        ...
        qunit.deepEqual(
            tools.arrayExtractIfPropertyExists([{a: 2}, {b: 3}], 'a'
        ), [{a: 2}])
    })
    qunit.test('arrayExtractIfPropertyMatches', () => {
        ...
        qunit.deepEqual(
            tools.arrayExtractIfPropertyMatches([{a: 'b'}], {a: 'a'}), [])
        qunit.deepEqual(tools.arrayExtractIfPropertyMatches([], {a: 'a'}), [])
        qunit.deepEqual(
            tools.arrayExtractIfPropertyMatches([{a: 2}], {b: /a/}), [])
        qunit.deepEqual(tools.arrayExtractIfPropertyMatches([{
    ...
    qunit.test('arrayIntersect', () => {
        ...
        qunit.deepEqual(
            tools.arrayIntersect([{a: 3}], [{b: 3}], ['b'], false), [])
        qunit.deepEqual(
            tools.arrayIntersect([{b: null}], [{b: null}], ['b']), [{b: null}])
        qunit.deepEqual(
            tools.arrayIntersect([{b: null}], [{b: undefined}], ['b']), [])
        qunit.deepEqual(
            tools.arrayIntersect([{b: null}], [{b: undefined}], ['b'], false),
            [{b: null}])
        qunit.deepEqual(
            tools.arrayIntersect([{b: null}], [{}], ['b'], false), [{b: null}])
        qunit.deepEqual(
            tools.arrayIntersect([{b: undefined}], [{}], ['b'], false),
            [{b: undefined}])
    ...
    qunit.test('stringAddSeparatorToPath', () => {
        ...
        qunit.strictEqual(tools.stringAddSeparatorToPath('/a/bb'), '/a/bb/')
        qunit.strictEqual(
            tools.stringAddSeparatorToPath('/a/bb', '|'), '/a/bb|')
        qunit.strictEqual(
            tools.stringAddSeparatorToPath('/a/bb/', '|'), '/a/bb/|')
    })
    ...
    qunit.test('stringGetPortNumber', () => {
        ...
        qunit.strictEqual(
            tools.stringGetPortNumber('https://localhost:89'), 89)
    })
    qunit.test('stringGetProtocolName', () => {
        ...
        qunit.strictEqual(
            tools.stringGetProtocolName('http://www.test.de'), 'http')
        qunit.strictEqual(tools.stringGetProtocolName(
        ...
        qunit.strictEqual(
            tools.stringGetProtocolName('ftp://localhost'), 'ftp')
        qunit.strictEqual(tools.stringGetProtocolName(
        ...
        qunit.strictEqual(
            tools.stringGetProtocolName('alternate.local/', 'c'), 'c')
        qunit.strictEqual(tools.stringGetProtocolName(
            '', location.protocol.substring(0, location.protocol.length - 1)
        ), location.protocol.substring(0, location.protocol.length - 1))
    })
    qunit.test('stringGetURLVariable', () => {
        ...
        qunit.strictEqual(
            tools.stringGetURLVariable('notExisting', '&'), undefined)
        qunit.strictEqual(
            tools.stringGetURLVariable('notExisting', '#'), undefined)
        qunit.strictEqual(
            tools.stringGetURLVariable('test', '?test=2'), '2')
        qunit.strictEqual(tools.stringGetURLVariable('test', 'test=2'), '2')
        qunit.strictEqual(
            tools.stringGetURLVariable('test', 'test=2&a=2'), '2')
        qunit.strictEqual(
    ...
    qunit.test('stringNormalizeURL', () => {
        ...
        qunit.strictEqual(
            tools.stringNormalizeURL('http://test'), 'http://test')
        qunit.strictEqual(
            tools.stringNormalizeURL('https://test'), 'https://test')
    })
    ...
    qunit.test('stringDelimitedToCamelCase', () => {
        ...
        qunit.strictEqual(tools.stringDelimitedToCamelCase('-'), '-')
        qunit.strictEqual(
            tools.stringDelimitedToCamelCase('hans-peter', '_'), 'hans-peter')
        qunit.strictEqual(
            tools.stringDelimitedToCamelCase('hans_peter', '_'), 'hansPeter')
        qunit.strictEqual(
    ...
    qunit.test('stringFormat', () => {
        ...
        qunit.strictEqual(
            tools.stringFormat('{1} test {2} - {2}', 1, 2), '1 test 2 - 2')
    })
    ...
    qunit.test('stringMD5', () => {
        ...
        qunit.strictEqual(
            tools.stringMD5(''), 'd41d8cd98f00b204e9800998ecf8427e')
    })
    ...
    qunit.test('numberIsNotANumber', () => {
        ...
        qunit.strictEqual(
            tools.numberIsNotANumber(new Date().toString()), false)
